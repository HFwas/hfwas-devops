...
-- 兼容已有数据库：补充 default_image 列
ALTER TABLE pipeline_task_kind ADD COLUMN default_image TEXT NOT NULL DEFAULT '';

-- 初始化 14 种 Task 类型（含默认工具镜像地址）
INSERT INTO pipeline_task_kind (kind_value, label, task_group, description, hint, default_command, requires_command, enabled, sort_order, tool_image, default_image) VALUES
